...
//           <div 
//             className="text-3xl font-black cursor-pointer tracking-tight hover:scale-105 transition-transform duration-300"
//             onClick={() => setCurrentPage('home')}
//           >
//             GoSWIFT<span className="text-gray-400">.</span>
//           </div>
...
//               >
//                 {label}
//                 <span className={`absolute -bottom-1 left-0 w-full h-0.5 bg-black transition-transform duration-300 ${
...
//                 key={key}
//                 onClick={() => setCurrentPage(key as Page)}
//                 className={`block w-full text-left py-3 text-lg font-semibold transition-colors ${
//                   currentPage === key ? 'text-black' : 'text-gray-500'
//                 }`}
//               >
//                 {label}
//               </button>
...
//           style={{
//             backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.5)), url('https://images.pexels.com/photos/1118448/pexels-photo-1118448.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`,
...
//               Reliable, fast and modern transport logistics.
//             </p>
//             <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
//               <button 
//                 onClick={() => setCurrentPage('contact')}
//                 className="group bg-white text-black px-10 py-5 text-xl font-bold tracking-wide hover:bg-gray-100 transition-all duration-300 inline-flex items-center gap-3 shadow-2xl hover:shadow-3xl transform hover:-translate-y-1"
//               >
//                 BOOK A PICKUP
...
//           <div className="text-sm font-medium">TRUSTED BY 10,000+ CLIENTS</div>
//         </div>
...
//               Comprehensive logistics solutions designed to meet every transportation need with precision and care.
//             </p>
//           </div>
...
//                 desc: 'Fast and secure delivery for all package sizes with real-time tracking and insurance coverage.',
...
//                 desc: 'Long-distance transport across the country with full truckload and LTL options.',
...
//                 <div className="relative overflow-hidden mb-6 h-64 bg-gray-100">
//                   <img 
//                     src={image}
//                     alt={title}
...
//                   </div>
//                 </div>
//                 <h3 className="text-2xl font-bold mb-4 group-hover:text-gray-600 transition-colors">{title}</h3>
//                 <p className="text-gray-600 leading-relaxed mb-4">{desc}</p>
//                 <button className="text-black font-semibold inline-flex items-center gap-2 group-hover:gap-3 transition-all">
...
//             {/* Connection Lines */}
//             <div className="hidden md:block absolute top-24 left-1/3 right-1/3 h-0.5 bg-black/20" />
...
//                     <div className="w-24 h-24 border-4 border-black rounded-full flex items-center justify-center bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
//                       <Icon size={40} />
//                     </div>
...
//             {[
//               { number: '50K+', label: 'Deliveries Completed', icon: Package },
...
//                 <Icon size={48} className="mx-auto mb-6 text-gray-400 group-hover:text-white transition-colors" />
...
//             Join thousands of satisfied customers who trust GoSwift for their logistics needs.
//           </p>
//           <button 
//             onClick={() => setCurrentPage('contact')}
//             className="group bg-black text-white px-12 py-6 text-xl font-bold tracking-wide hover:bg-gray-800 transition-all duration-300 inline-flex items-center gap-3 shadow-2xl hover:shadow-3xl transform hover:-translate-y-1"
//           >
//             GET STARTED TODAY
//             <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
//           </button>
...
//                 className="w-full h-[500px] object-cover grayscale shadow-2xl"
//               />
...
//                 About<br />
//                 <span className="text-gray-400">GoSwift</span>
//               </h1>
//               <p className="text-xl leading-relaxed mb-8 text-gray-700">
//                 Founded with a mission to revolutionize logistics, GoSwift Logistics combines 
//                 cutting-edge technology with reliable service to deliver your goods safely 
//                 and efficiently across the nation.
//               </p>
//               <p className="text-xl leading-relaxed mb-8 text-gray-700">
...
//                 <div className="bg-gray-100 px-6 py-3 font-semibold">ISO Certified</div>
//                 <div className="bg-gray-100 px-6 py-3 font-semibold">24/7 Support</div>
//                 <div className="bg-gray-100 px-6 py-3 font-semibold">Nationwide Coverage</div>
//               </div>
//             </div>
//           </div>
//         </div>
...
//             <div className="text-center p-12 bg-white shadow-lg">
...
//                 in every delivery we make.
//               </p>
//             </div>
//             <div className="text-center p-12 bg-black text-white">
//               <h3 className="text-3xl font-black mb-6">Our Vision</h3>
//               <p className="text-lg text-gray-300 leading-relaxed">
//                 To become the leading logistics provider nationwide, known for innovation, 
...
//                 <div className="w-20 h-20 mx-auto mb-6 border-2 border-black rounded-full flex items-center justify-center group-hover:bg-black group-hover:text-white transition-all duration-300">
//                   <Icon size={40} />
//                 </div>
//                 <h3 className="text-2xl font-bold mb-4">{title}</h3>
//                 <p className="text-gray-600 leading-relaxed text-lg">{desc}</p>
...
//             {[
//               {
//                 quote: "GoSwift has transformed our supply chain. Their reliability and speed are unmatched in the industry. We've seen a 40% improvement in delivery times.",
//                 author: "Sarah Johnson",
//                 company: "TechCorp Industries",
//                 role: "Supply Chain Director"
//               },
//               {
//                 quote: "Professional service, competitive rates, and always on time. We couldn't ask for a better logistics partner. They handle our most critical shipments.",
//                 author: "Michael Chen",
//                 company: "Global Retail Solutions",
//                 role: "Operations Manager"
//               }
//             ].map(({ quote, author, company, role }, index) => (
//               <div key={index} className="p-8 border border-gray-600 hover:border-white transition-colors">
...
//             from small parcels to large freight shipments across the nation.
//           </p>
//         </div>
//       </section>
...
//               ],
//               image: 'https://images.pexels.com/photos/1118448/pexels-photo-1118448.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
...
//                 <div className="grid grid-cols-3 gap-6 mb-8 p-6 bg-gray-50">
...
//                 <button 
//                   onClick={() => setCurrentPage('contact')}
//                   className="bg-black text-white px-8 py-4 font-bold hover:bg-gray-800 transition-colors inline-flex items-center gap-2"
//                 >
//                   GET QUOTE
//                   <ArrowRight size={20} />
//                 </button>
...
//                   <th className="p-6 text-center text-lg font-bold">Parcel</th>
//                   <th className="p-6 text-center text-lg font-bold">Freight</th>
//                   <th className="p-6 text-center text-lg font-bold">Express</th>
//                   <th className="p-6 text-center text-lg font-bold">Business</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {[
...
//                       <td key={cellIndex} className="p-6 text-center text-lg">
//                         {cell === '✓' ? <CheckCircle size={20} className="mx-auto text-green-600" /> : cell}
//                       </td>
//                     ))}
//                   </tr>
//                 ))}
...
//         style={{
//           backgroundImage: `linear-gradient(rgba(255,255,255,0.95), rgba(255,255,255,0.95)), url('https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`,
...
//             {/* Form */}
//             <div>
//               <h2 className="text-4xl font-black mb-8">Get Your Quote</h2>
...
//                       required
//                       className="w-full p-4 border-2 border-gray-300 focus:border-black transition-colors text-lg bg-gray-50 focus:bg-white"
...
//                     onChange={handleInputChange}
//                     rows={6}
//                     className="w-full p-4 border-2 border-gray-300 focus:border-black transition-colors text-lg resize-none bg-gray-50 focus:bg-white"
...
//                 <button
//                   type="submit"
//                   className="w-full bg-black text-white py-6 text-xl font-bold tracking-wide hover:bg-gray-800 transition-colors duration-300 inline-flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
//                 >
//                   SUBMIT REQUEST
//                   <ArrowRight size={24} />
//                 </button>
...
//                     <p className="text-gray-300">info@goswiftlogistics.com</p>
//                     <p className="text-gray-300">support@goswiftlogistics.com</p>
//                   </div>
//                 </div>
...
//                     <p className="text-gray-300">1-800-GOSWIFT</p>
//                     <p className="text-gray-300">(1-800-467-9438)</p>
//                   </div>
//                 </div>
...
//                 <h4 className="text-xl font-bold mb-4">Why Choose GoSwift?</h4>
...
//               <p className="text-xl font-bold">1-800-GOSWIFT</p>
//             </div>
...
//               <p className="text-xl font-bold">support@goswift.com</p>
//             </div>
            
//             <div className="text-center p-8 bg-black text-white shadow-lg hover:shadow-xl transition-shadow">
...
//               © 2025 GoSwift Logistics. All rights reserved.
//             </p>
